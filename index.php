...
<body>
    ...
    <div class="container mx-auto bg-light mt-1 w-90">
        <header class="row">
            ...
            <div class="col-sm-3">
                <img src="images/logo.jpg" alt="Logotipo da empresa com dois triângulos sobrepostos." width="80">
            </div>
          ...
          consulte https://getbootstrap.com.br/docs/4.1/components/navbar/ -->
                <nav class="navbar navbar-expand-md navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarTogglerDemo02">
                      <ul class="navbar-nav mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                          <a class="nav-link text-muted" href="#">Contato</a>
                        </li>
                      </ul>
                    </div>
                  </nav>
            ...
            <div class="col-12">
                ...
                <form action="#" method="post" class="needs-validation" novalidate>
                    <fieldset>
                        <legend class="d-none">Informe seu nome, e-mail e a mensagem</legend>
